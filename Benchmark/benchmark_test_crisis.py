...
path_datasets_folder = f"./crisis/datasets"
path_recalibration_folder = f"./crisis/experimental_files"
...
data.to_csv(f"crisis/datasets/my_data.csv")


# specify the test period
begin_test = "2021-01-16 00:00"
end_test = "2024-01-15 23:00"
...
calibration_window_LEAR = 364


# Folders for data and output
path_datasets_folder = os.path.join(".", f"crisis/datasets")
path_recalibration_folder = os.path.join(".", f"crisis/experimental_files")
# run Lear
...
file_execution_time_lear = (
    f"crisis/execution_time_lear.pkl"
)
joblib.dump(execution_time_lear, file_execution_time_lear)


forecast_lear = pd.read_csv(
    f"crisis/experimental_files/LEAR_forecast_datmy_data_YT2_CW364.csv",
    index_col=False,
)
...
max_evals = 500
path_datasets_folder = f"./crisis/datasets/"
path_hyperparameters_folder = f"./crisis/experimental_files/"
...
path_datasets_folder = os.path.join(".", f"crisis/datasets")
path_recalibration_folder = os.path.join(".", f"crisis/experimental_files")
path_hyperparameter_folder = os.path.join(".", f"crisis/experimental_files")
...
file_execution_time_dnn = (
    f"crisis/execution_time_dnn.pkl"
)
joblib.dump(execution_time_dnn, file_execution_time_dnn)


forecast_DNN = pd.read_csv(
    f"crisis/experimental_files/DNN_forecast_nl2_datmy_data_YT2_SFH0_CW1_1.csv",
    index_col=False,
)
