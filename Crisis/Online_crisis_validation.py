...
# Keep the last 3 years for test
N = 3 * 365
...
def objective_init(trial):
    ...
    D_init = trial.suggest_int("D_init", 30, 365)
    ...
    D_all = trial.suggest_int("D_all", 1, 365)
    ...
    overall_mean, _, forecast = forecast_MLP_rolling(
    dat_eval,
    begin_eval,
    regmat_tensor_eval,
    dependent_var_tensor_eval,
...
file_boa_weights = f"{country}/Model{model_type}/step_weights.pkl"
