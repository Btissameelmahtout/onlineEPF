...
from my_functions import forecast_ensemble, evaluate_parameter_grid
...
if model_type == 3 and country == "Germany":
    # Grid Search Analysis for D_all
    D_all_grid = [1, 4, 7, 14, 21, 28, 42, 56, 70, 91, 137, 183, 228, 274, 365, 400, 730]
    parameter_name="D_all"
    parameter_grid=D_all_grid
    df_D_all = evaluate_parameter_grid(
    parameter_name=parameter_name,
    parameter_grid=parameter_grid,
    dat_test=dat_test,
    begin_test=begin_test,
    regmat_tensor_test=regmat_tensor_test,
    dependent_var_tensor_test=dependent_var_tensor_test,
    regmat0_test=regmat0_test,
    days_test=days_test,
    learning_rate_init=learning_rate_init,
    num_epochs_init=num_epochs_init,
    D_init=D_init,
    ...
    # Grid Search Analysis for D_init
    D_init_grid = [7, 28, 42, 56, 70, 91, 137, 183, 228, 274, 365, 456, 502, 593,639, 730,]

    parameter_name="D_init"
    parameter_grid=D_init_grid
    df_D_init = evaluate_parameter_grid(
    parameter_name=parameter_name,
    parameter_grid=parameter_grid,
    dat_test=dat_test,
    begin_test=begin_test,
    ...
    # Grid Search Analysis for num_epochs_init
    num_epochs_init_grid = [10, 20, 30, 40, 50, 55, 60, 65, 70, 80, 100]

    parameter_name="num_epochs_init"
    parameter_grid=num_epochs_init_grid
    df_num_epochs_init = evaluate_parameter_grid(
    parameter_name=parameter_name,
    parameter_grid=parameter_grid,
    dat_test=dat_test,
    begin_test=begin_test,
   ...
   #Grid Search Analysis for num_epochs_all
    num_epochs_all_grid = [1, 2, 3, 5, 7, 10, 12, 16, 20, 25, 30, 40, 50, 60]

    parameter_name="num_epochs_all"
    parameter_grid=num_epochs_all_grid
    df_num_epochs_all = evaluate_parameter_grid(
    parameter_name=parameter_name,
    parameter_grid=parameter_grid,
    dat_test=dat_test,
    begin_test=begin_test,
